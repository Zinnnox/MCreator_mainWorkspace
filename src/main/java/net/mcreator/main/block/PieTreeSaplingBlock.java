package net.mcreator.main.block;
...
public class PieTreeSaplingBlock extends SaplingBlock {
	public static final TreeGrower TREE_GROWER = new TreeGrower("pie_tree_sapling", Optional.empty(), Optional.of(getFeatureKey("main:pie_tree")), Optional.empty());

	public PieTreeSaplingBlock(BlockBehaviour.Properties properties) {
